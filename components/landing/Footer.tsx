...
export function Footer() {
  return (
    <footer className="relative overflow-hidden border-t border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900">
      <div className="mx-auto max-w-[1440px] px-6 py-16 lg:px-12 lg:py-20">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 text-sm text-zinc-500">Designed for focus.</p>
          </div>
      ...
      <div className="relative h-24 overflow-hidden lg:h-32">
        <span className="absolute bottom-0 left-0 right-0 text-center text-[80px] font-bold leading-none tracking-tighter text-zinc-900 dark:text-zinc-100 opacity-[0.03] lg:text-[120px]">
          MINIDRIVE © 2025
        </span>
      </div>
    </footer>
